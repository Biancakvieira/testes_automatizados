...
public class CadastroPagesPF_CPF_ERRO {
    static WebDriver driver;

    public CadastroPagesPF_CPF_ERRO(WebDriver driver) {
        this.driver = driver;
    }

    public void preencherCampoPF_CPF_ERRO() {
        ...
        document.sendKeys("537.771.350-79");
    ...
    public void verificaAvisoCpfInvalido() {
        WebElement CPFinválido = driver.findElement(By.xpath("//span[contains(text(),'CPF inválido')]"));
        String mensagemErro = CPFinválido.getText();
