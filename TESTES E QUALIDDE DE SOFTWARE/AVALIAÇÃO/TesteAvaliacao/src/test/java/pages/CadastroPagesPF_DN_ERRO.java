...
public class CadastroPagesPF_DN_ERRO {
    static WebDriver driver;

    public CadastroPagesPF_DN_ERRO(WebDriver driver) {
        this.driver = driver;
    }

    public void preencherCampoPF_DN_ERRO() {
        ...
        Data_de_nascimento.sendKeys("11112020");
    ...
    public void verificaAvisoDnInvalido() {
        WebElement Vocêprecisater18anos = driver.findElement(By.xpath("//span[contains(text(),'Você precisa ter 18 anos')]"));
        String mensagemErro = Vocêprecisater18anos.getText();
        String mensagemErroEsperada = "Você precisa ter 18 anos";
